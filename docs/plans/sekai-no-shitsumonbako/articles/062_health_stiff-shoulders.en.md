# Q. What are the common misunderstandings about stiff shoulders (katakori)?｜Japan Questions #62
...
> **[Verify]** The figures are based on the MHLW summary report. **If giving the actual per-1,000 figure for katakori, take it from Table 98 on e-Stat (Japan's government statistics portal).**

## Misunderstanding 1｜The harder you press, the better it works

Strong stimulation is not suitable in every case. **Avoid force strong enough to hurt.**

## Misunderstanding 2｜It is only about posture

Time spent in the same posture, eye strain, feeling cold, stress and more: **several factors are described as being involved.** The MHLW guideline on work with information devices (screen work) says not to continue for more than one hour at a stretch, and that advice sits in this context.

## Misunderstanding 3｜It happens because you do not exercise enough

Too much exercise can cause it as well. **Do not pin it on a single cause.**

## Misunderstanding 4｜Warming it always makes it better

The right response differs with the condition. **Do not judge every case the same way.**

## Misunderstanding 5｜It is fine to leave it

**If you have numbness, weakness, strong pain, or symptoms that persist, do not rely on your own judgement — see a doctor.** Another cause may be hidden behind it.
