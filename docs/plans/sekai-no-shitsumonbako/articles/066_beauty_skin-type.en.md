# Q. What are the common misunderstandings about knowing your skin type?｜Japan Questions #66

- Shelf: `beauty` ／ URL: `/en/beauty/skin-type` ／ Status: **Draft — English edition, sources unverified**
...
> **[Verify]** The percentages are based on private surveys (HANA LABO, Naris Cosmetics and others) and the SCCJ glossary. **Check the sources and survey years before publication, and name the body that ran each survey.**

## Misunderstanding 1｜Once decided, it never changes

The same person's skin changes between summer and winter, and with physical condition. **Judge by "how your skin is now" rather than by "skin type".**

## Misunderstanding 2｜Oily on the surface means oily skin

Some people feel oily on the surface yet dry underneath. **It also differs from one part of the face to another.**

## Misunderstanding 3｜The readings from a skin-analysis device are everything

Measurements are a useful guide, but readings move with the time of day and with whether you washed your face just before. **Do not decide on the basis of a single measurement.**

## Misunderstanding 4｜"For sensitive skin" suits everyone

Because there is no definition, **the label is a guide and does not show that a product suits everyone.** Try any new product on an inconspicuous area first.

## Misunderstanding 5｜Skin type explains skin trouble

**If redness, itching or eczema persists, do not put it down to your skin type — see a dermatology clinic (covered by Japanese health insurance).**

---

### Sources

- Society of Cosmetic Chemists of Japan (SCCJ), cosmetics glossary, "Sensitive skin" [化粧品用語集「敏感肌」]
