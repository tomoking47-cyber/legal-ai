# Q. What do people get wrong about over-the-counter medicine in Japan?｜Japan Questions #147

- Shelf: `inbound` ／ URL: `/en/questions/over-the-counter-medicine` ／ Status: **Draft — sources unverified**
...
## A. The common misunderstanding is that a drugstore sells everything a pharmacy does. Japan divides non-prescription medicines into four classes; the strongest (Class 1 and "guidance-required") can only be sold by a licensed pharmacist who is present, so smaller shops and late-night hours may not have them.
...
### Sources
- Ministry of Health, Labour and Welfare — OTC medicine classification (一般用医薬品の区分)
  https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000092820.html
- Ministry of Health, Labour and Welfare — Multilingual guide for pharmacies
  https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/iyakuhin/index.html
- Japan Association of Chain Drug Stores — Store finder (English)
