# Q. What are the common misunderstandings about caring for silk?｜Japan Questions #171

- Shelf: `fashion` ／ URL: `/en/fashion/silk-care` ／ Status: **Draft — English edition, sources unverified**

Around the world, silk is avoided as "difficult to look after". Japan, however, has generations of know-how from handing down silk kimono within families. Here we set that know-how out alongside Japan's care-label system, so you can read the label on a silk item bought here and act on it.

## A. The biggest misunderstanding is "silk cannot be washed at home". If the care label shows the hand-wash symbol, you can wash it at home. Failures come not from washing itself but from water temperature, the type of detergent, rubbing, and sunlight. The basics are "30°C (86°F) or below, neutral detergent, press-wash, dry in the shade".
...
## Misunderstanding 1｜Silk has no option other than the dry cleaner

**If the label shows the hand-wash symbol, you can wash it at home.** For expensive, dark-coloured or lined items, asking a dry cleaner is the safer side.

## Misunderstanding 2｜Washing with shampoo does no harm

Shampoo ingredients vary widely from product to product, and **some are alkaline or leave conditioning agents behind**. **A neutral detergent for delicates** is the reliable choice.

## Misunderstanding 3｜The colour ran because of the detergent

Silk is a fibre whose **dyes dissolve easily in water**. **Test for colour-fastness in a hidden spot**, and wash **on its own and briefly**. **Water stains** (marks left only where the fabric got wet) are also a characteristic of silk.
...
Silk is a fibre **moths readily eat**, so repellent is needed, but **direct contact with the repellent can discolour it**. **Wrap the item in non-woven fabric and place the repellent on top** of the clothes. For long-term storage, **air it in the shade once or twice a year**.
...
- Japan Textile Products Quality and Technology Center (QTEC), "Basic knowledge of textiles" [繊維の基礎知識]
