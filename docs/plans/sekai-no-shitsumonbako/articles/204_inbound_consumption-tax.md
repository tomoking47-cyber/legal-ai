# Q. What do people get wrong about consumption tax in Japan?｜Japan Questions #204

- Shelf: `inbound` ／ URL: `/en/questions/consumption-tax` ／ Status: **Draft — sources unverified**

Two rates, one country, and a receipt that sometimes shows both: Japan's consumption tax confuses visitors mainly because the rate depends on whether you eat in or take away.

## A. The common misunderstanding is that Japan has a single sales tax. Since October 2019 there are two rates — 10% standard and 8% reduced for food and drink to take away and for newspapers — and the same convenience-store onigiri is taxed at 8% if you take it out and 10% if you eat it at the counter. Prices must be displayed tax-inclusive.
...
## Misunderstanding 1｜"Eat-in" is just a choice of seat

It changes the tax. Staff at convenience stores and bakeries ask **"tennai de?" (eating here?)** because they must charge **10%** instead of **8%**. Answer honestly; the difference on a snack is small.

## Misunderstanding 2｜The price on the shelf excludes tax

Since April 2021 it must **include** tax. Where two numbers appear, the larger is tax-inclusive.

## Misunderstanding 3｜Alcohol to take away is 8% like other drinks

Alcohol is **always 10%**, even in a supermarket basket. Non-alcoholic beer and soft drinks are 8%.
...
There is no service-tax logic here; tax is on the bill and tipping is not practised (see the tipping article).

---

### Sources
- National Tax Agency — Consumption tax: rates and reduced rate system
  https://www.nta.go.jp/english/taxes/consumption_tax/
- National Tax Agency — Tax-inclusive price display (総額表示)
  https://www.nta.go.jp/taxes/shiraberu/zeimokubetsu/shohi/kaisei/
- Kyoto City — Accommodation tax (宿泊税)
