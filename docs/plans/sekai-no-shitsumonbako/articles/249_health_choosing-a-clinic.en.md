# Q. What are the common misunderstandings about choosing a clinic and knowing when to go?｜Japan Questions #249

- Shelf: `health` ／ URL: `/en/health/choosing-a-clinic` ／ Status: **Draft — English edition, sources unverified**
...
| **Medical Information Net (Navii)** | The MHLW's **nationwide search for medical institutions** (specialty, hours, languages spoken) |

- Japan's **outpatient visits run at about 12 a year per person**, nearly twice the OECD average of about 6 (OECD Health Statistics). **Care is easy to access**, but **crowding at big hospitals** is described as a problem.
- Bring your **medicine notebook (お薬手帳, okusuri techō)**: it allows **checks for duplicate prescriptions and interactions**, and the pharmacy's **management fee can be lower**.

> **[Verify]** Check the charge amounts and the range of hospitals covered against the latest MHLW documents, and #7119 coverage with the Fire and Disaster Management Agency.

## Misunderstanding 1｜Go straight to a big hospital and you get the best

**Without a referral letter you pay ¥7,000 or more extra**, and **waits are long**. **Start at a clinic** and ask for a referral letter if needed.
...
**A doctor who sees you over time can judge with your history, medicines and lifestyle in mind, and refers you faster.** Choose one clinic that is **close to home and easy to talk to**.

## Misunderstanding 4｜At night or on holidays only the emergency hospital is open

**Municipal holiday and night emergency clinics and on-duty doctors** exist. Check **the municipal website or #7119**.

## Misunderstanding 5｜If I look up my symptoms myself, I do not need to see anyone

Information helps you decide, but **diagnosis is the doctor's domain**. If symptoms **persist, worsen or feel unusual**, go. **Web information, this article included, is no substitute for a diagnosis.**

---

### Sources

- Ministry of Health, Labour and Welfare, "Fixed charge for visits without a referral letter (selected medical care)" [紹介状なしで受診する場合等の定額負担（選定療養）]
  https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/iryouhoken/
- Fire and Disaster Management Agency, "Emergency Advice Centre programme (#7119)" [救急安心センター事業（#7119）]
  https://www.fdma.go.jp/mission/enrichment/appropriate/appropriate007.html
- Ministry of Health, Labour and Welfare, "Medical Information Net (Navii)" [医療情報ネット（ナビイ）]
