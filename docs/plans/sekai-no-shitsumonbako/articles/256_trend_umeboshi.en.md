# Q. What are the common misunderstandings about umeboshi (pickled plums)?｜Japan Questions #256

- Shelf: `trend` ／ URL: `/en/trend/umeboshi` ／ Status: **Draft — English edition, sources unverified**
...
| Category (name on the food label) | Salt | Storage | Features |
|---|---|---|---|
...
> **[Verify]** The salt figures are guidelines based on the Standard Tables of Food Composition in Japan and product labels. Check the label categories against the Consumer Affairs Agency's "Food Labelling Standards".
...
**There is no public basis for asserting such an effect, and it may not be claimed on labels.** What is certain is that umeboshi is **a food containing salt and citric acid** and can be **one way of replacing salt after heavy sweating**; that is as far as it goes.

## Misunderstanding 3｜Umeboshi is an "alkaline food", so it is good for you

**"Alkaline food" is a concept with little meaning in nutrition science**; food does not change the body's pH. **The value of umeboshi lies in its taste and its history as a preserved food.**

## Misunderstanding 4｜Low-salt umeboshi are healthy, so you can eat lots

**Even the low-salt type has 0.5–1 g of salt per plum**, and **honey types contain sugar** too. **One or two a day** is the usual guideline.
...
- Consumer Affairs Agency, "Food Labelling Standards" (names for pickled agricultural products: umeboshi and seasoned umeboshi) [食品表示基準]
  https://www.caa.go.jp/policies/policy/food_labeling/food_labeling_act/
- Ministry of Agriculture, Forestry and Fisheries, "Cyanogenic glycosides in plum stones and unripe plums" [梅の種子・未熟な梅の青酸配糖体について]
