# Q. What do people get wrong about posting souvenirs home from Japan?｜Japan Questions #269

- Shelf: `inbound` ／ URL: `/en/questions/postal-services-shipping-home` ／ Status: **Draft — sources unverified**
...
| Service | Speed | 5 kg to US/Europe (approx.) | Notes |
|---|---|---|---|
| **EMS** | **3–7 days**, tracked, insured to ¥20,000 | **¥10,000–15,000** | Max **30 kg**; size limit 1.5 m longest side |
| **Airmail parcel** | 1–2 weeks | ¥8,000–12,000 | Tracking optional |
| **Economy air (SAL)** | 2–3 weeks | ¥6,000–9,000 | Suspended to some countries |
| **Surface (sea) parcel** | **1–3 months** | **¥4,000–6,000** | Cheapest; fine for books, ceramics packed well |
| Small packet (up to 2 kg) | 1–2 weeks | ¥1,500–3,500 | For light items |
...
## Misunderstanding 1｜It is cheaper to pay excess baggage

Airline excess-baggage fees run **¥5,000–15,000 per bag or per kilo band**; a **5 kg surface parcel at ¥4,000–6,000** is usually cheaper if you can wait.

## Misunderstanding 2｜Any post office can handle it

**Any post office can accept international parcels**, but small ones may have staff unfamiliar with the electronic form. **Main post offices** in cities have English forms and long hours.

## Misunderstanding 3｜Write the address and hand it over

Many destinations now **require the electronic customs declaration**; a handwritten CN22/23 alone can be rejected. Do it on your phone before you queue.

## Misunderstanding 4｜Anything you bought legally can be posted

**Perfume, aerosols and most cosmetics with alcohol cannot go by air**; **lithium batteries** have strict rules; **food** depends on the destination (meat almost never). Ask at the counter with the item visible.
...
### Sources
- Japan Post — International mail: services, rates and prohibited items (English)
  https://www.post.japanpost.jp/int/index_en.html
- Japan Post — International Mail My Page (electronic customs declaration)
  https://www.post.japanpost.jp/intmypage/
- Japan Customs — Export procedures for travellers
