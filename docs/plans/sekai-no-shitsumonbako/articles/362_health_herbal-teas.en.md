# Q. What are the common misunderstandings about herbal teas?｜Japan Questions #362
...
| Category | Examples | What can be said |
|---|---|---|
| **Food (herbal tea)** | Chamomile, rooibos, peppermint, rosehip | **No health claims allowed.** Only mood-setting phrases such as "for your relaxing moment" |
| **Medicine (crude drugs, 生薬)** | Dokudami tea (products approved as a crude drug), senna, kanzō (liquorice root) | The approved indication. **Senna is a medicinal ingredient and cannot be used in food** (the stem is an exception allowed in food) |
| **Foods with Function Claims / FOSHU** | Only products that have been notified or approved | The function within the scope of the notification |

FOSHU (トクホ) is Japan's approved "Food for Specified Health Uses" scheme; Foods with Function Claims (機能性表示食品) are notified to the Consumer Affairs Agency by the maker.

### Herbs with well-known cautions
...
| **Mint** | Can make **gastro-oesophageal reflux** worse |
| **Pregnancy in general** | Much guidance says **avoid, or take only small amounts of, raspberry leaf, jasmine, sage, lemongrass and others**. **Check with your obstetrician** |

- **"ノンカフェイン" (non-caffeine) and "カフェインゼロ" (caffeine zero)** mean only that **the product contains no caffeine**. **They do not mean it has no other effects.**
- The **National Institute of Health and Nutrition's database on the safety and effectiveness of "health foods"** publishes **interactions and cautions for each herb**.

> **[Verify]** Check the St John's wort caution against the MHLW notice (May 2000) and each herb's cautions against the National Institute of Health and Nutrition database.

## Misunderstanding 1｜It is natural, so it is safe

**St John's wort weakens the effect of many medicines, and liquorice affects blood pressure.** **If you take medication, are pregnant or have a chronic condition, check with a doctor or pharmacist.**

## Misunderstanding 2｜Caffeine-free means no effect on the body

**Only the caffeine is missing.** **The herb's own compounds act on the body**, which is exactly why interactions exist.

## Misunderstanding 3｜It is fine to say herbal tea has health benefits

**Herbal teas sold as food cannot carry health claims** (Health Promotion Act; Act against Unjustifiable Premiums and Misleading Representations). **Stating flatly that it "relaxes" or "helps you sleep" is a problem.**

## Misunderstanding 4｜Herbal tea is the ideal drink in pregnancy

**Some herbs should be avoided.** **Even if a product says "OK during pregnancy", check with your obstetrician.** **Rooibos and barley tea (麦茶, mugicha) are generally described as unproblematic**, but keep quantities sensible.

## Misunderstanding 5｜Stronger and more often works better

**The stronger and longer you drink it, the more likely both the effects and the interactions.** **Around 1–3 cups a day**; stop if you notice a change in how you feel.
