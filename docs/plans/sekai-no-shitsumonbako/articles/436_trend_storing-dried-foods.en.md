# Q. What are the common misunderstandings about storing dried foods (kombu, dried shiitake, seaweed, beans)?｜Japan Questions #436

- Shelf: `trend` ／ URL: `/en/trend/storing-dried-foods` ／ Status: **Draft — English edition, sources unverified**

Dried foods (乾物, kanbutsu) are the foundation of the Japanese kitchen and ideal for stockpiling, but the belief that "it is dry, so it keeps for years" leads to insects, mould and rancid fats. Here we set out how to store each kind of dried food, and the key points on rehydrating them.

## A. The biggest misunderstanding is "dried food is dry, so it will not spoil wherever you keep it." Dried food that absorbs moisture goes mouldy; anything with oil in it (dried sardines, sesame, nuts) goes rancid; and beans, rice and flour attract insects. The basics are: "once opened, move to a sealed container in a cool, dark place (or the fridge or freezer)", "add a desiccant" and "use within a year". Know that the white powder on kombu is umami, and learn to tell mould from harmless crystals on dried shiitake.
...
| **Dried beans (soybeans, azuki, chickpeas)** | Room temperature, 1–2 years | **Sealed, cool dark place.** **Old beans rehydrate poorly and stay hard when cooked** | **Insects (grain weevils, etc.).** Fridge or freezer is the safe choice | Soak overnight (azuki need no soaking) |
| **Kiriboshi daikon (dried radish strips), kanpyō (dried gourd)** | Room temperature | **Sealed, fridge** (the colour changes) | Humidity, browning | 15–20 minutes in water |
| **Sesame, nuts** | Room temperature | **Fridge or freezer** (rancidity) | Rancid smell | — |
| **Flours (wheat flour, potato starch, kinako soybean flour)** | Room temperature | **Sealed, fridge** (insects, mites) | **Allergy cases caused by mites** (opened packs left at room temperature) | — |
...
## Misunderstanding 1｜Dried food keeps for years

**Humidity, oxidation and insects lower the quality.** **Once opened, seal it and use within a year**; **anything oily goes in the fridge or freezer.**
...
**Opened flour left at room temperature has bred mites and caused allergy cases.** **Seal, refrigerate and use soon.**

## Misunderstanding 5｜Old beans will soften if you cook them long enough

**Old beans have tough skins, rehydrate poorly and resist cooking.** **Use within 1–2 years.** **Adding a pinch of baking soda to the cooking water** is one method, but the flavour suffers.

---

### Sources

- National Consumer Affairs Center of Japan, "Allergies caused by mites breeding in opened wheat flour and similar products" [開封後の小麦粉等に発生したダニによるアレルギー]
