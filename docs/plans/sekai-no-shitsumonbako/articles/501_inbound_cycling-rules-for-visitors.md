# Q. Can I rent a bicycle in Japan, and what are the rules I might not expect?｜Japan Questions #501

- Shelf: `inbound` ／ URL: `/en/questions/cycling-rules-for-visitors` ／ Status: **Draft — sources unverified**
...
| **Alcohol** | **Riding after drinking is a crime**, treated like drunk driving. From November 2024, "riding under the influence" carries **up to 3 years' prison or ¥500,000** | Criminal |
| **Phones** | **Holding a phone while riding**: from November 2024 **up to 6 months' prison or ¥100,000**; causing danger, up to 1 year | Criminal |
| **Umbrellas** | Holding an umbrella while riding is an offence (fixed umbrella holders exist but are also restricted in many prefectures) | Fine |
| **Lights** | **Front light required after dark**; rear reflector or light | Fine |
| **Two abreast / passengers** | Not allowed except signed lanes; **no adult passengers**. Children under 6 in approved child seats only | Fine |
| **Earphones** | Restricted by prefectural rules where they impede hearing | Fine |
| **Parking** | **Designated bicycle parking only** (paid: **¥100–200/day** typical). Bikes on pavements in "removal zones" are impounded | **¥2,000–5,000** recovery fee, ID required |

- **Rental options**: **Share cycles** (Docomo Bike Share, HELLO CYCLING, LUUP) via app and credit card, **¥130–165 per 30 min** or **¥1,500–2,000/day**; **tourist rental shops** ¥1,000–2,500/day; **hotel bikes** often free. Most share e-bikes are pedal-assist, capped at 24 km/h.
- **LUUP and electric kick-scooters**: a separate category since July 2023 ("specified small motorised bicycle") — **age 16+, 20 km/h limit, helmet recommended, no licence**; the road/pavement rules differ again. Check the app's briefing.
...
### Sources
- National Police Agency — Bicycle safety rules and the 2024 amendments to the Road Traffic Act
  https://www.npa.go.jp/bureau/traffic/bicycle/
- Tokyo Metropolitan Police — Bicycle riding rules and impound (removal) procedures
  https://www.keishicho.metro.tokyo.lg.jp/kotsu/jikoboshi/bicycle/
- Japan Tourism Agency / JNTO — Cycling in Japan (rules for visitors)
