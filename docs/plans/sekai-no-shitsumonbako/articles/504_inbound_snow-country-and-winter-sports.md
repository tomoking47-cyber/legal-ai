# Q. Visiting Japan in winter: what do people get wrong about snow, skiing and getting around?｜Japan Questions #504

- Shelf: `inbound` ／ URL: `/en/questions/snow-country-and-winter-sports` ／ Status: **Draft — sources unverified**
...
- **Clothing that works**: a **waterproof outer layer**, **thermal base**, **hat, gloves, neck warmer**; **heat pads (kairo)** from any convenience store, ¥100–500 for a pack. **Umbrellas are used in wet Kanto snow, not in dry Hokkaido snow.**
- **Buildings**: **watch for falling snow and icicles** from roofs (**roof-snow falls kill several people each winter**, mostly in the countryside); walk on the road side of the pavement under overhanging eaves.
- **Snow festivals**: **Sapporo Snow Festival (early February)** draws 2 million; **Yokote, Zao's snow monsters, Shirakawa-go illuminations** — book accommodation months ahead.
- **Onsen in snow**: rotenburo (outdoor baths) are the reward, but **alcohol + hot water + cold air** causes fainting; drink water, limit soaks to 10–15 minutes.
- **Carbon monoxide**: **do not run a car engine in a snowdrift** (blocked exhaust) — an annual cause of deaths during Japan Sea coast blizzards.

> **[Verify]** Snowfall averages and Sapporo fall-injury counts with JMA and Sapporo City data; lift-pass and rescue cost ranges with current resort and insurer information.

---

### Sources
- Japan Meteorological Agency — Snow depth statistics and heavy-snow warnings
  https://www.jma.go.jp/jma/indexe.html
- Sapporo City — Winter walking safety ("Tsuru-tsuru" ice information)
  https://tsurutsuru.jp/
- Japan Avalanche Network — Backcountry advisories and resort rules
  https://nadare.jp/
