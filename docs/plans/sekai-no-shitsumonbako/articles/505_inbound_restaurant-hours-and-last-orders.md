# Q. Why did the restaurant turn me away at 8:30 pm? Opening hours, last orders and closing days in Japan｜Japan Questions #505

- Shelf: `inbound` ／ URL: `/en/questions/restaurant-hours-and-last-orders` ／ Status: **Draft — sources unverified**
...
- **Sunday and holidays**: **business districts (Marunouchi, Nihonbashi, Shinbashi) empty out** — many lunch places close on weekends. **Golden Week, mid-August Obon and 29 Dec–3 Jan**: independent restaurants close for **several days to two weeks**; this is the single biggest gap in visitors' planning.
- **Booking**: many top places take **reservations only by phone in Japanese** or through **hotel concierges**; **TableCheck, Omakase, Pocket Concierge** cover a growing set. **No-shows are charged** (see the cancellation article).
- **Seating time limits**: **90–120 minutes** at busy izakaya and cafés, printed on the menu. Not rude — it's the model.
- **Kitchen etiquette**: at L.O. the server will ask "**Last order desu**" — order everything then. **Sitting on with drinks after closing is not done**; you'll be asked to pay.
- **Google Maps hours are often wrong**; **Tabelog** (Japanese) is usually accurate, and a **same-day check of the restaurant's own social media** is the reliable method.

> **[Verify]** Typical hour patterns are editorial generalisations; verify with current listings. Seasonal closure periods (Golden Week, Obon, New Year) vary by establishment.
