# Q. What are the emergency numbers in Japan, and what is a kōban?｜Japan Questions #509

- Shelf: `inbound` ／ URL: `/en/questions/emergency-numbers-and-police-boxes` ／ Status: **Draft — sources unverified**
...
- **Police powers**: officers may **ask for your passport** (you must carry it as a visitor) and **stop-and-question (shokumu shitsumon)** is legal; **cooperate politely** — it is usually about a bicycle or a missing sticker.
- **Carry**: **passport**, **hotel card with address in Japanese**, **travel-insurance number**, **your embassy's number**. Embassies help with lost passports and arrests, not with medical bills.

> **[Verify]** Kōban and chūzaisho counts with the NPA; #7119 coverage areas with the FDMA; the JNTO hotline number with the JNTO page.

---

### Sources
- National Police Agency — How to call the police (110) and the kōban system
  https://www.npa.go.jp/english/
- Fire and Disaster Management Agency — Calling 119 in Japan (multilingual guide)
  https://www.fdma.go.jp/en/
- Japan National Tourism Organization — Japan Visitor Hotline and emergency information
