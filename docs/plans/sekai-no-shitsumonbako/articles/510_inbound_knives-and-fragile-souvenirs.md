# Q. Buying a Japanese kitchen knife or ceramics: how do I get them home?｜Japan Questions #510

- Shelf: `inbound` ／ URL: `/en/questions/knives-and-fragile-souvenirs` ／ Status: **Draft — sources unverified**

Japanese kitchen knives and ceramics are two of the most-bought serious souvenirs, and both create airport problems: a knife cannot go in your hand luggage anywhere in the world, and a ¥30,000 Arita porcelain bowl does not survive a checked bag without planning. Shops in Japan are used to this and have solutions, if you know to ask.

## A. Knives must travel in checked baggage — there is no exception for boxed or new blades — and Japan also regards a knife with a blade over 6 cm carried in public as an offence unless you have a "legitimate reason" such as carrying it home from the shop, so keep the receipt and the box sealed. Good knife shops wrap the blade in a saya (wooden sheath) or hard case and will ship internationally by EMS for ¥3,000–8,000, which for a valuable blade is the safest route. For ceramics, ask the shop to pack for shipping (they use double boxes), or carry them in hand luggage wrapped in clothing — never in a checked bag alone. Both can be bought tax-free; both count toward your home customs allowance.

## Knives

| Item | Detail |
|---|---|
| **Aviation** | **No knives of any size in hand luggage** (Japan and worldwide). **Checked baggage is fine**, blade sheathed and wrapped. Boxed and receipted new knives are still refused at security |
| **Carrying in Japan** | **Swords and Firearms Control Law / Minor Offences Act**: carrying a blade **over 6 cm** (kitchen knives included) without legitimate reason is an offence. **Legitimate reason = taking a purchase home** — keep the **receipt** and **shop packaging sealed**, go straight to the hotel |
...
| Item | Detail |
|---|---|
| **Packing** | Good shops **double-box with paper and bubble** for travel on request ("**hakobi yasui yō ni tsutsunde kudasai**"). Say **airplane (hikōki)** and they'll pack harder |
| **Where it goes** | **Hand luggage** for anything you care about — checked bags are thrown. Weight limits (**7–10 kg** on most carriers' cabin bags) are the constraint |
| **Shipping** | **EMS or Yamato international**; **¥5,000–15,000** for a 5 kg box to Europe/US; **shop shipping usually includes insurance** |
...
> **[Verify]** Blade-length rule (6 cm) with the NPA; EMS prices and knife shipping restrictions with Japan Post and destination-country customs; 2026 tax-free changes with the NTA.

---

### Sources
- Ministry of Land, Infrastructure, Transport and Tourism — Prohibited items in carry-on baggage (knives, blades)
  https://www.mlit.go.jp/koku/15_bf_000006.html
- National Police Agency — Swords and Firearms Control Law / carrying blades in public
  https://www.npa.go.jp/english/
- Japan Post — EMS international shipping of goods (prohibited and restricted items)
