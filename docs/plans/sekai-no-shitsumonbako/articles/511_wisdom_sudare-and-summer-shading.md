# Q. What do people get wrong about sudare, the Japanese summer blind?｜Japanese Everyday Wisdom #511

- Shelf: `wisdom` ／ URL: `/en/wisdom/sudare-and-summer-shading` ／ Status: **Draft — sources unverified**
...
- **Which windows**: **south and west** — the west-facing afternoon sun is the one that heats bedrooms for the evening. **North-facing windows don't need it.**
- **Ventilation**: a sudare lets **breeze through** and **hides the interior** — the traditional way to open windows in dense neighbourhoods without being seen. It's why Kyoto machiya still hang them.
- **Balconies**: attach to the balcony rail with S-hooks or ties; **check your building rules** — some ban anything on the exterior. Renters: no drilling; use tension poles or rail hooks.
- **Green curtains** (bitter gourd, morning glory on a net) are the living version and give the same shading with **higher humidity and a crop** (see the balcony gardening article).
- **Modern versions**: **aluminium-coated sunshade screens**, **awning cloth on a tension pole** — same principle, longer life, less charm.
- **Winter**: take it down; you want the sun.

> **[Verify]** Percentage reductions in solar heat and air-conditioning use come from utility/university trials cited in METI and MOE materials; confirm the specific figures before publication.
...
- Tokyo Metropolitan Government — Heat-island countermeasures: uchimizu and shading trials
