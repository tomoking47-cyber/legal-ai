# Q. How do I spot a fake designer bag or garment? Will customs seize one I bought online from abroad?｜Japan Questions #539
...
|---|---|
| **Price** | **A new item at 30–50% of retail or less** is suspect. Popular bags sell secondhand at around 70% of retail |
| **Channel** | **An unknown site reached via a social-media advert**, **a domain of brand name + numbers**, **bank transfer as the only payment method**, **unnatural Japanese**, **heavy emphasis on "genuine" and promises of authenticity** |
| **Logo and engraving** | **Wrong font weight or letter spacing**, **shallow or uneven engraving on hardware**, **no engraving on the zip pull** |
| **Stitching** | **Uneven stitch spacing**, **untidy thread ends**, **left and right not symmetrical** |
| **Material, smell, weight** | **A chemical smell to the leather**, **grain too uniform for real leather**, **too light or too heavy** |
| **Accessories** | **Box, dust bag and authenticity card come with fakes too.** **Serial numbers are copied as well**, so none of these is conclusive |
| **Seller** | **Several "new, unused" listings of the same popular model**, **a new account whose ratings jumped suddenly** |

- **The reliable way**: **official boutiques, authorised dealers and department stores**, or **major reuse chains with in-house authenticators** (Komehyo, Daikokuya, Brand Off, etc.; **check they hold a secondhand-dealer licence, 古物商許可**). On flea-market apps, **use the "authenticated transaction" option**.
- **Worried after buying**: **authentication services** (¥3,000–10,000 per item, in person or online). On a flea-market app, **authenticate before you confirm receipt**; if it is fake, **file a claim with the platform's support desk**.
- **"Parallel imports" are not fakes**: a parallel import is **a genuine item imported through a route other than the authorised dealer**, and is legal. **The maker's warranty may not apply**, however.
...
**Fakes come with accessories and serial numbers too.** They settle nothing; channel and price are more trustworthy signals.

## Misunderstanding 3｜The listing says "genuine", so it is safe

**Sometimes the seller does not know it is fake.** If the price is low or there are many new items listed, be suspicious and use an authenticated transaction.

## Misunderstanding 4｜If I bought a fake, I can resell it to get my money back

**Selling a fake breaches the Trademark Act and carries criminal penalties.** Asking for a refund through the platform's compensation scheme is the legitimate route.

## Misunderstanding 5｜Parallel imports are fakes

**A parallel import is a genuine item brought in by another route, and is legal.** Only the warranty is handled differently. An unknown site calling itself a "parallel importer" at absurdly low prices is another matter.
