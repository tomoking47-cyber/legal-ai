# Q. Can visitors use PayPay and other QR-code payment apps in Japan?｜Japan Questions #581

- Shelf: `inbound` ／ URL: `/en/questions/qr-payment-apps-for-visitors` ／ Status: **Draft — sources unverified**

Japan went from cash to QR codes in about five years: PayPay stickers are now on noodle-shop counters, temple donation boxes and farm stands. Visitors see "PayPay / d払い / au PAY" everywhere and assume they can join in. Mostly they cannot — but the workarounds are good and getting better.

## A. Most Japanese QR apps require a Japanese phone number and bank account or a Japan-issued card, so short-term visitors cannot sign up for PayPay, d払い or Rakuten Pay directly. What works instead: your home country's app if it is linked — Alipay, WeChat Pay, Kakao Pay and several Southeast Asian wallets scan Japanese QR codes through interoperability agreements — plus contactless credit cards (Visa/Mastercard tap) which are accepted at most places that take QR, and a Suica or PASMO transit card loaded with cash or added to Apple Wallet. Carry ¥10,000–20,000 in cash for the shrines, small restaurants and rural shops where none of these work.

## What visitors can and cannot use
...
### Sources
- Japan Tourism Agency / JNTO — Payment methods in Japan for visitors (cash, cards, IC cards, QR)
  https://www.japan.travel/en/plan/money/
- PayPay Corporation — Merchant acceptance of Alipay+ and overseas wallets
  https://paypay.ne.jp/
- JR East — Welcome Suica and Mobile Suica for visitors
