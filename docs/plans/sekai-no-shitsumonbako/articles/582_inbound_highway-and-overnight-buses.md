# Q. Are Japan's highway and overnight buses worth it? What visitors get wrong｜Japan Questions #582
...
| **Osaka – Fukuoka** | ¥5,000–9,000 | ¥15,000 | 9–10 h vs 2.5 h |
| **Tokyo – Kawaguchiko (Fuji)** | ¥2,000–2,500 | (no shinkansen; train ¥4,000+) | 2 h |

## Seat classes (what the names mean)

| Class | Layout | Recline | Comfort | Who it suits |
|---|---|---|---|---|
| **4-row (4列) standard** | 2+2, narrow | Limited | Cramped for anyone over 175 cm | Budget day trips |
| **4-row "relax" / wide** | 2+2 with more pitch | Moderate | Acceptable overnight for short people | Budget overnight |
| **3-row (3列) independent** | 1+1+1 with aisles between every seat | **Deep (up to ~140°)**, footrest, **privacy curtain** | **The sleeping standard** | Overnight |
...
- **Sleep**: bring **neck pillow, eye mask, earplugs, a hoodie** (air conditioning), **slippers** (you'll remove shoes). Overnight buses arrive **05:00–07:00**; **plan a café, station locker and the hotel's early check-in or luggage hold**.
- **Risks**: **traffic delays of 1–3 hours** in bad weather, **snow closures** on the Japan Sea side, **the 2016 Karuizawa crash** led to tighter operator rules — **book established operators**, not the cheapest unknown.
- **When not to**: a **flight within 3 hours of scheduled arrival**, **children under 6 overnight**, **anyone with back problems in 4-row seats**.

> **[Verify]** Fare ranges with current operator listings (Willer, JR Bus); annual passenger figure with MLIT statistics; terminal names and stop locations for the current season.
