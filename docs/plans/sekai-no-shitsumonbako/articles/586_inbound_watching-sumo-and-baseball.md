# Q. How do I get tickets for sumo and baseball in Japan, and what should I expect?｜Japan Questions #586

- Shelf: `inbound` ／ URL: `/en/questions/watching-sumo-and-baseball` ／ Status: **Draft — sources unverified**

Sumo tournaments and professional baseball are the two spectator events visitors most want, and both are misunderstood: sumo is six 15-day tournaments a year with tickets that sell out in hours, and baseball is a nightly show with organised cheering sections, beer vendors with kegs on their backs, and a seventh-inning balloon release. Getting in is easier than the myths suggest — if you know the calendar.

## A. Sumo: the grand tournaments (honbasho) run 15 days each in January, May and September (Tokyo), March (Osaka), July (Nagoya) and November (Fukuoka). Tickets go on sale about a month before via the Sumo Association's official site (Ticket Oosumo, English available) and sell out for weekends and the final days within a day; weekday arena seats (¥4,000–9,000) are the realistic target, box seats (¥10,000–15,000 per person, shared 4-person masu) need speed or a resale partner. Arrive by 14:00 for the top-division ring entering ceremony at ~15:40 and bouts until 18:00. Baseball: 12 teams, March–October, tickets ¥2,000–8,000 on team sites or Lawson/7-Eleven ticket machines, rarely sold out except Giants/Tigers/Hawks derbies and playoffs. Sit in the outfield for the cheering culture, behind home plate to watch the game.
...
| **Can't get tickets** | **Morning practice (asa-geiko) at a stable** via a tour (¥10,000–15,000, strict silence), **the Sumo Museum (free) at Kokugikan on non-tournament days**, **regional exhibition tours (jungyō)** in other months |
...
> **[Verify]** Sale dates and prices with the current tournament announcement; stadium-specific rules on outside food and balloons; NPB season dates for the year.

---

### Sources
- Japan Sumo Association — Official ticket information (Ticket Oosumo) and tournament schedule
  https://sumo.pia.jp/en/
- Nippon Professional Baseball — Schedule and ticket information
  https://npb.jp/eng/
- National Police Agency — Act on Ensuring Proper Ticket Resale (2019)
  https://www.npa.go.jp/
