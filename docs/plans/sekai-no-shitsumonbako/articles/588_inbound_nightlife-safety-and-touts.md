# Q. Is Japan's nightlife safe? Touts, "bottakuri" bars and how to avoid being overcharged｜Japan Questions #588

- Shelf: `inbound` ／ URL: `/en/questions/nightlife-safety-and-touts` ／ Status: **Draft — sources unverified**
...
| Scam | What happens | Where | Defence |
|---|---|---|---|
| **Bottakuri bar** | Tout offers "**¥3,000 nomihōdai**" or "girls bar"; **bill is ¥50,000–500,000** with table charge, per-hostess drinks, "**tax and service 40%**"; **door blocked**, card forced | **Kabukichō (Shinjuku), Roppongi, Ikebukuro, Osaka Minami, Nagoya Sakae, Fukuoka Nakasu** | **Never follow a tout**; **confirm prices in writing**; **pay as you go**; **leave immediately if the menu is unclear** |
| **Drink spiking + card fraud** | Drugged in a bar/club, taken to ATMs, **card used for ¥300,000–1,000,000**; victims remember little | **Roppongi, Kabukichō** (US Embassy warnings since 2009) | **Don't accept drinks from strangers, watch the pour, don't leave drinks**; **carry one card with a low limit** |
| **"Free" karaoke or hostess invitation** | Foreign-speaking tout offers a free drink or intro | Same districts | Same |
| **Unlicensed "massage" or "girls bar" upstairs** | Prices multiply once inside | Same | Ground-floor, visible, priced venues only |
| **Taxi rounds** | Rare — Japanese taxis are metered and honest; **unlicensed cars (shirotaku)** near clubs are not | Roppongi late nights | Use licensed taxis (green plates) or apps (GO, Uber) |
...
| Option | Why |
|---|---|
| **Izakaya, standing bars (tachinomi), yokochō alleys (Omoide Yokochō, Golden Gai — with posted prices)** | Priced menus, no touts; **Golden Gai bars post cover charges (¥500–1,500) on the door** — check before entering |
| **Hotel bars, department-store rooftop beer gardens** | Predictable prices |
| **Clubs with published entry (WOMB, ageHa successors, Sound Museum Vision)** | Pay at the door, ID required, no hostesses |
| **Karaoke chains (Big Echo, Karaoke-kan)** | Priced per 30 minutes, drinks on the menu |
...
### Sources
- Tokyo Metropolitan Police — Warning on "bottakuri" bars in Shinjuku and Roppongi; Shinjuku Ward anti-touting ordinance
  https://www.keishicho.metro.tokyo.lg.jp/kurashi/
- U.S. Embassy in Japan — Safety message on drink spiking and credit-card fraud in Roppongi and Kabukicho
  https://jp.usembassy.gov/services/
- Osaka Prefecture — Ordinance on prevention of nuisance touting (Minami / Kita districts)
