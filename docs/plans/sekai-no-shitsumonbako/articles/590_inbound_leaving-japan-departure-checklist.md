# Q. Leaving Japan: the departure tax, airport timing, tax-free checks and what visitors forget｜Japan Questions #590

- Shelf: `inbound` ／ URL: `/en/questions/leaving-japan-departure-checklist` ／ Status: **Draft — sources unverified**
...
| Airport | Get there | Last trains from the city | Recommended arrival before departure |
|---|---|---|---|
| **Narita (NRT)** | **Narita Express (60–90 min, ¥3,070 from Tokyo), Keisei Skyliner (41 min from Ueno, ¥2,570), Airport Limousine bus (75–120 min, ¥3,200), LCC buses (¥1,300–1,500 from Tokyo station)** | **N'EX last ~20:00–21:00 from Tokyo; Keisei ~22:00–23:00; buses to ~22:00** | **3 hours** (Terminal 3 LCCs: allow extra for the 500 m walk) |
| **Haneda (HND)** | **Monorail (13–20 min from Hamamatsuchō), Keikyū (15–20 min from Shinagawa), buses** | **Trains run to ~00:00; Keikyū to ~00:30** | **2.5 hours** |
| **Kansai (KIX)** | **Haruka (50 min from Osaka/Tennōji, 75 from Kyoto), Nankai Rapi:t (35 min from Namba), buses** | **Haruka last ~21:00–22:00; Nankai ~23:30** | **3 hours** (queues at KIX immigration/security can be long in peak) |
| **Chūbu (NGO)** | Meitetsu μ-Sky (28 min from Nagoya) | ~23:00 | 2.5 hours |
| **Fukuoka (FUK)** | Subway (5 min from Hakata) | ~00:00 | 2 hours |

- **Early flights (before 08:00)**: **stay near the airport** (Narita: Narita city hotels + shuttle; Haneda: Kawasaki/Shinagawa or the in-terminal hotels; KIX: Rinku Town) or take the **first train (~05:00)**, which reaches Narita ~06:30 — tight for a 07:30 flight.
- **Luggage forwarding to the airport**: **Yamato/JAL ABC counters** deliver from hotels to the airport counter for **¥2,000–3,000 per bag (send 2 days ahead)**; collect at the terminal.
...
- **Rubbish**: Japanese airports have bins — the rest of the city rarely does.
- **Last convenience-store run**: **onigiri and drinks for the plane** are legal through security if bought before (liquids no) — buy inside the terminal after security.
- **Omiyage for the office at home**: **airport shops sell the same Tokyo Banana/Shiroi Koibito boxes as the city**, at the same price; **the tax-free counter also works at the airport shops**.

> **[Verify]** Last-train times and fares with current timetables; the 2026 tax-free refund-at-departure change with the NTA; power-bank rules with the airline and MLIT.

---

### Sources
- Ministry of Finance / Japan Customs — Departure procedures: tax-free goods verification, cash declaration
  https://www.customs.go.jp/english/
- National Tax Agency — International Tourist Tax (¥1,000) and the consumption tax exemption system for visitors
  https://www.nta.go.jp/english/taxes/consumption_tax/
- JR East — Suica refund procedures; Welcome Suica terms
